...
weights_path = "data/results/sum_reward_expected_sarsa_agent.npy"
weights = np.load(weights_path, allow_pickle=True)
# Ensure to set the agent's weights, if applicable
# Example: agent.set_weights(weights)
...
create_video_from_frames(frames, 'agent_performance.mp4', 30)