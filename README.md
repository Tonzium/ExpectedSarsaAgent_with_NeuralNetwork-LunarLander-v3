...
This project is a modern, professional evolution of my earlier work on the **LunarLander-v2** environment. 
...
- **Improved Stability:** Integrated a **Target Network** to solve catastrophic forgetting, a major challenge in deep reinforcement learning.
...
- **Manual Neural Network Implementation:** A multi-layer perceptron built using only **NumPy**, including manual forward propagation, backpropagation, and Saxe weight initialization.
