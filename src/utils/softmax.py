...
class mathematics:
    ...
    def softmax(self,action_values, tau=1.0):
        ...
        max_preference = np.max(preferences, axis=1)  #Easier way would be to keepdims=True and remove the lower line of code
        ...
        sum_of_exp_preferences = np.sum(exp_preferences, axis=1) #Easier way would be to keepdims=True and remove the lower line of code
